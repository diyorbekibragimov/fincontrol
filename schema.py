...
conn.commit()
# cursor.execute("CREATE TABLE records (id SERIAL PRIMARY KEY, operation BOOLEAN NOT NULL, value DECIMAL NOT NULL, date TIMESTAMP NOT NULL DEFAULT Now(), currency INTEGER NOT NULL,FOREIGN KEY(currency) REFERENCES currencies(id) ON DELETE SET NULL)")
# conn.commit()
